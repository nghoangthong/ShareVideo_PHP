...
class SettingsFormProvider {
    ...
    public function createPasswordForm() {
        $oldPasswordInput = $this->createPasswordInput("oldPassword", "Mật khẩu cũ");
        $newPassword1Input = $this->createPasswordInput("newPassword", "Mật khẩu mới");
        $newPassword2Input = $this->createPasswordInput("newPassword2", "Nhập lại mật khẩu mới");
